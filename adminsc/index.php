                            ...
                            <form action="index.php" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input type="password" name="passwd" class="form-control" id="passwordInput" placeholder="Enter your password">
                                        <div class="input-group-text" onclick="togglePasswordVisibility()" style="cursor: pointer;">
                                            <img id="togglePasswordIcon" src="assets\images\eye.svg" alt="Toggle Password Visibility" style="width: 20px; height: 20px;">
                                        </div>
                                    </div>
                                </div>
